		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsasazappreportinflresvf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsasazappreportinflresvf-display": {
								"semanticObject": "nsasazappreportinflresvf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.asa.zappreportinflresvf",
									"url": sap.ui.require.toUrl("ns/asa/zappreportinflresvf")
								}
							}
						}
					}
